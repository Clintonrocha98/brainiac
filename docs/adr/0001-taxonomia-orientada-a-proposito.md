# Taxonomia de documentação orientada a propósito, não a departamento

O Catálogo classifica cada Entrada primariamente pelo **propósito** do documento
(que tipo de conhecimento ele entrega), e trata **departamento** e **audiência**
como facetas (metadados), não como a hierarquia de topo.
...
Consequência: departamento deixa de ser o ponto de entrada da navegação e passa a
ser um filtro. Pessoas que pensam "quero ver as coisas da minha área" precisam de
uma view filtrada por essa faceta — não de uma pasta.
